    ...
    return(
      ...
      >
        <Modal.Header className="text-[#435971]">Customer Details</Modal.Header>
          <Modal.Body>
        <form className="space-y-4 max-h-[500px] overflow-y-scroll" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
            ...
            />
            {errors.address_line1 && <p className="text-red-500 text-sm">Required</p>}
          </div>
          ...
          <div className="flex gap-4">
            <div className="w-full">
              ...
              <TextInput
                ...
                placeholder="08:00"
              />
              {errors.start_time && <p className="text-red-500 text-sm">Required</p>}
            </div>
            ...
            <div className="w-full">
              ...
              <TextInput
                ...
                placeholder="22:30"
              />
              {errors.end_time && <p className="text-red-500 text-sm">Required</p>}
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              {errors.postal_code && <p className="text-red-500 text-sm">Required</p>}
            </div>
            <div>
              <Label value="Country" />
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              {errors.slug && <p className="text-red-500 text-sm">Required</p>}
            </div>
            <div>
