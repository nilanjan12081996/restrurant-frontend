        ...
        <div className="flex flex-grow items-center justify-between px-6 py-3 shadow-2">
            ...
            <div className="">
                ...
                <button
                    ...
                    className="z-99999 block rounded-full bg-[#BD55C6] p-1 absolute top-[28px] left-[-60px]"
                >
                ...
                <Link className="block flex-shrink-0" to="/">
                    ...
                    <span className='text-base text-[#323232]'>Welcome to <span className='text-[#BD55C6] font-semibold'>ATAHOPE</span> Dashboard</span>
                </Link>
            </div>
