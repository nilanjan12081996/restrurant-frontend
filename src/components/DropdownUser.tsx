      ...
      >
        {/* <ul className="flex flex-col gap-3 border-b border-stroke px-4 py-4">
          <li>
            <Link
              to="/profile"
              className="flex items-center gap-2 text-sm font-normal duration-300 ease-in-out text-[#2E2E2E] hover:text-[#536EFF]"
            >
        ...
        <button onClick={handleLogout} className="flex items-center gap-2 py-3 px-4 text-sm font-normal duration-300 ease-in-out text-[#2E2E2E] hover:text-[#536EFF]">
